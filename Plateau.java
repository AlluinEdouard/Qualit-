...
class Plateau{
    ...
    public Plateau(){
        ...
        this.initialiserPlateauClassique();
    }

    public Plateau(boolean cheat){
        pieces = new ArrayList<Piece>();
        if(cheat)
            this.initialiserPlateauAvecTavaliers();
        else
            this.initialiserPlateauClassique();
    }

    private void initialiserPlateauClassique() {
    ...
    private void initialiserPlateauAvecTavaliers() {
        this.initialiserPlateauClassique();
        this.ajouterPiece(new Tavalier('B', new Position("B1")));
        this.ajouterPiece(new Tavalier('B', new Position("G1")));
        this.ajouterPiece(new Tavalier('N', new Position("B8")));
        this.ajouterPiece(new Tavalier('N', new Position("G8")));
    }

    private boolean ajouterPiece(Piece p){
        // Vérifier si une pièce n'est pas déjà placée sur la case.
